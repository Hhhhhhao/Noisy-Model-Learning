...
class CIFAR10:
    def __init__(self, 
        ...
        if num_shots is not None:
            ...
            selected_data, selected_targets = sample_num_shot(self.train_dataset.data, self.train_dataset.targets, 10, num_shots)
        ...
        if noise_ratio is not None:
            ...
            data, noisy_targets = sample_noise_data(self.train_dataset.data, self.train_dataset.targets, 10, noise_ratio)
