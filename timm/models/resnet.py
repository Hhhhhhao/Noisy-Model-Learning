...
default_cfgs = {
    ...
    # trained using same commands
    'resnet50_orig': _cfg(
        file='pretrained_models/r50_in1k_clean/model.pth.tar',
        interpolation='bicubic', crop_pct=0.95),
    'resnet50_noise_5': _cfg(
        file='pretrained_models/r50_in1k_random_noise_5/model.pth.tar',
        interpolation='bicubic', crop_pct=0.95),
    'resnet50_noise_10': _cfg(
        file='pretrained_models/r50_in1k_random_noise_10/model.pth.tar',
        interpolation='bicubic', crop_pct=0.95),
    'resnet50_noise_20': _cfg(
        file='pretrained_models/r50_in1k_random_noise_20/model.pth.tar',
        interpolation='bicubic', crop_pct=0.95),
    'resnet50_noise_30': _cfg(
        file='pretrained_models/r50_in1k_random_noise_30/model.pth.tar',
        interpolation='bicubic', crop_pct=0.95),

    'resnet50_cifar100_noise_1_25': _cfg(
        file='pretrained_models/r50_in1k_cifar100_noise_1.25/model.pth.tar',
        interpolation='bicubic', crop_pct=0.95),
    'resnet50_cifar100_noise_2_5': _cfg(
        file='pretrained_models/r50_in1k_cifar100_noise_2.5/model.pth.tar',
        interpolation='bicubic', crop_pct=0.95),
    'resnet50_cifar100_noise_3_75': _cfg(
        file='pretrained_models/r50_in1k_cifar100_noise_3.75/model.pth.tar',
        interpolation='bicubic', crop_pct=0.95),
    'resnet50_cifar100_noise_5': _cfg(
        file='pretrained_models/r50_in1k_cifar100_noise_5/model.pth.tar',
        interpolation='bicubic', crop_pct=0.95),
    'resnet50_cifar100_noise_10': _cfg(
        file='pretrained_models/r50_in1k_cifar100_noise_10/model.pth.tar',
        interpolation='bicubic', crop_pct=0.95),
...
@register_model
def resnet50_orig(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
    """
    model_args = dict(block=Bottleneck, layers=[3, 4, 6, 3],  **kwargs)
    return _create_resnet('resnet50_orig', pretrained, **dict(model_args, **kwargs))

@register_model
def resnet50_noise_5(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
    """
    model_args = dict(block=Bottleneck, layers=[3, 4, 6, 3],  **kwargs)
    return _create_resnet('resnet50_noise_5', pretrained, **dict(model_args, **kwargs))

@register_model
def resnet50_noise_10(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
    """
    model_args = dict(block=Bottleneck, layers=[3, 4, 6, 3],  **kwargs)
    return _create_resnet('resnet50_noise_10', pretrained, **dict(model_args, **kwargs))


@register_model
def resnet50_noise_20(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
    """
    model_args = dict(block=Bottleneck, layers=[3, 4, 6, 3],  **kwargs)
    return _create_resnet('resnet50_noise_20', pretrained, **dict(model_args, **kwargs))

@register_model
def resnet50_noise_30(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
    """
    model_args = dict(block=Bottleneck, layers=[3, 4, 6, 3],  **kwargs)
    return _create_resnet('resnet50_noise_30', pretrained, **dict(model_args, **kwargs))

@register_model
def resnet50_cifar100_noise_1_25(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
    """
    model_args = dict(block=Bottleneck, layers=[3, 4, 6, 3],  **kwargs)
    return _create_resnet('resnet50_cifar100_noise_1_25', pretrained, **dict(model_args, **kwargs))


@register_model
def resnet50_cifar100_noise_2_5(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
    """
    model_args = dict(block=Bottleneck, layers=[3, 4, 6, 3],  **kwargs)
    return _create_resnet('resnet50_cifar100_noise_2_5', pretrained, **dict(model_args, **kwargs))

@register_model
def resnet50_cifar100_noise_3_75(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
    """
    model_args = dict(block=Bottleneck, layers=[3, 4, 6, 3],  **kwargs)
    return _create_resnet('resnet50_cifar100_noise_3_75', pretrained, **dict(model_args, **kwargs))

@register_model
def resnet50_cifar100_noise_5(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
    """
    model_args = dict(block=Bottleneck, layers=[3, 4, 6, 3],  **kwargs)
    return _create_resnet('resnet50_cifar100_noise_5', pretrained, **dict(model_args, **kwargs))

@register_model
def resnet50_cifar100_noise_10(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
    """
    model_args = dict(block=Bottleneck, layers=[3, 4, 6, 3],  **kwargs)
    return _create_resnet('resnet50_cifar100_noise_10', pretrained, **dict(model_args, **kwargs))

@register_model
def resnet50_noise_10_seperate(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
    """
    model_args = dict(block=Bottleneck, layers=[3, 4, 6, 3],  **kwargs)
    return _create_resnet('resnet50_noise_10_seperate', pretrained, **dict(model_args, **kwargs))
